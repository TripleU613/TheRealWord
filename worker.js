...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .word { font-size: clamp(3rem, 15vw, 8rem); font-weight: 900; text-transform: uppercase; letter-spacing: 0.05em; }
...
<body>
    ...
    <script>
        ...
        wordText.split('').forEach(char => { const span = document.createElement('span'); span.className = 'letter'; span.textContent = char === ' ' ? '\\u00A0' : char; wordEl.appendChild(span); });
